...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">{{ $category->name }} kategoriyasini tahrirlash</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Kategoriya ma'lumotlari</h2>
        </div>
        
        <form action="{{ route('admin.categories.update', [$restaurant, $project, $category]) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="Masalan: Hot dishes">
                    @error('name')
